...
- Empresa que deseja revisar práticas internas para reduzir riscos e passivo trabalhista.
- Necessidade de defesa em reclamação trabalhista já ajuizada por ex-funcionário.
- Dúvidas sobre enquadramento de contratos, terceirização ou práticas de gestão de pessoal do ponto de vista de risco trabalhista.
- Empresas em recuperação judicial ou reestruturação que precisam avaliar o passivo trabalhista envolvido.
...
Empresas com passivo trabalhista relevante identificado em auditoria ou due diligence.

Reclamações trabalhistas individuais que exigem defesa técnica.

Dúvidas sobre terceirização, pejotização ou enquadramento de vínculo empregatício.

Empresas em recuperação judicial avaliando o impacto da classe trabalhista no plano de recuperação.

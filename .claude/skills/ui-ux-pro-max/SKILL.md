---
name: ui-ux-pro-max
description: "Repertório de UI/UX pesquisável localmente (estilos, paletas, pares tipográficos, 1.9k famílias Google Fonts, padrões de landing page, motion, diretrizes de UX, stack Astro). Use ao definir direção de arte, escolher tipografia/cor/layout, estruturar seções de landing page ou revisar decisões visuais. Fork enxuto do ui-ux-pro-max para este projeto."
---

# UI/UX Pro Max - Design Intelligence

> **Fork enxuto para Corrêa Lima Advocacia.** Domínios ativos: `style`, `color`,
> `landing`, `product`, `ux`, `typography`, `gsap`, `google-fonts`. Stacks: `astro`, `react`.
> Removidos por não se aplicarem a esta landing: `chart`, `icons`, `react` (performance),
> `web` (app-interface), 20 stacks e a suíte de testes do upstream.
>
> **Esta skill é REPERTÓRIO, não veredito.** O Result 1 costuma ser o clichê mais
> popular (typography.csv linha 1 = Playfair Display + Inter). Consulte sempre com
> `--variance 8-10`, leia o conjunto e escolha contra a média. Quem aprova ou reprova
> qualquer resultado é a skill `direcao-de-arte`.
...
# Step 4: stack guidelines
python ".claude/skills/ui-ux-pro-max/scripts/search.py" "island hydration directive" --stack astro
```
